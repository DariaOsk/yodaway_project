...
videopath = "../../research/cam1.mp4"

def main():
    # sys.argv[0]=1
    # sys.argv[1]=videopath
    # sys.argv[2]="."

    kalman_filter_tracker(videopath, "kalman.txt")
...
if __name__ == '__main__':
    ...
    # read video file
    video = cv2.VideoCapture*(videopath); #(sys.argv[2]);
