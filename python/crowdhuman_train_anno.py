...
ano_path = "./images/CrowdHuman/CrowdHuman_train01/Images"
intPERSON = 0
intHEAD   = 1
...
#crowdhuman_train1 has 5000 images
def generate_annotations(ii, return_dict, ano_path):
    ...
    img = cv2.imread(ano_path + 'crowdhuman_train/{}.jpg'.format(strID),1)

    imgWidth  = img.shape[1]
    imgHeight = img.shape[0]

    # Create .txt label file
    with open(ano_path + 'crowdhuman_train/{}.txt'.format(strID), 'w+') as txtf:
